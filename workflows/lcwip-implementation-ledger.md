...
| Issue [#97](https://github.com/awjreynolds/banes-satn/issues/97) | Merged | [#109](https://github.com/awjreynolds/banes-satn/pull/109) | `220f9ee` | Both CI jobs passed; refreshed `main`: 15 focused publication passes and Ruff clean after the 440-pass full-suite controller gate, package build and four-page PDF render audit. |
| Issue [#98](https://github.com/awjreynolds/banes-satn/issues/98) | In review | [#110](https://github.com/awjreynolds/banes-satn/pull/110) | — | SOL spec/standards gate clean; 12 focused monitoring passes, 452 full-suite passes, 9 opt-in skips, Ruff clean, wheel/sdist build clean, CLI valid, and desktop/mobile Chromium overflow and accessibility checks green. |
