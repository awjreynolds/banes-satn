...
| Issue [#94](https://github.com/awjreynolds/banes-satn/issues/94) | Validated; PR pending | — | — | Controller gate: 7 focused transparent-prioritisation tests, 401 full-suite passes with 9 opt-in skips, Ruff clean, wheel/sdist build and prioritisation CLI clean; local Standards and Spec acceptance clean. |
