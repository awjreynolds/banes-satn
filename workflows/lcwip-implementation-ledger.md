...
| Issue [#95](https://github.com/awjreynolds/banes-satn/issues/95) | In review | [#107](https://github.com/awjreynolds/banes-satn/pull/107) | — | Controller gate: 9 focused governance tests, 410 full-suite passes with 9 opt-in skips, Ruff clean, wheel/sdist build and governance CLI clean; local SOL Standards and Spec acceptance clean. |
