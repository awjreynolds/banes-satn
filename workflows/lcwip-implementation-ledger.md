...
| Issue [#97](https://github.com/awjreynolds/banes-satn/issues/97) | Ready for review | — | — | SOL spec/standards gates clean; 15 focused publication passes, 440 full-suite passes, 9 opt-in skips, Ruff clean, wheel/sdist build clean, CLI valid, and all four A4 PDF pages rendered and visually inspected. |
