...
| Issue [#98](https://github.com/awjreynolds/banes-satn/issues/98) | Ready for review | — | — | SOL spec/standards gate clean; 12 focused monitoring passes, 452 full-suite passes, 9 opt-in skips, Ruff clean, wheel/sdist build clean, CLI valid, and desktop/mobile Chromium overflow and accessibility checks green. |
